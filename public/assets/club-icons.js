/* ============================================================================
   Club OftalmoBlack — sprite de ícones compartilhado

   Os 21 primeiros vieram do protótipo de /membros/ sem mudança; o resto foi
   acrescentado para o painel do admin. Mesmo traço (Feather, stroke 2).

   Uso: <svg class="ic"><use href="#i-nome"/></svg>  ou  Club.icon('nome')
   ========================================================================= */
(function () {
  'use strict';

  var SPRITE = '<symbol id="i-eye" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></symbol>' +
    ...
    '<symbol id="i-brain" viewBox="0 0 24 24"><path d="M12 5.5a3 3 0 0 0-5.7-1.3A2.7 2.7 0 0 0 4 6.8c0 .5.1 1 .4 1.4A2.8 2.8 0 0 0 3 10.7c0 1 .5 2 1.3 2.5-.2.4-.3.9-.3 1.4a2.9 2.9 0 0 0 2.6 2.9A2.9 2.9 0 0 0 9.5 20c1.3 0 2.4-.9 2.5-2z"/><path d="M12 5.5a3 3 0 0 1 5.7-1.3A2.7 2.7 0 0 1 20 6.8c0 .5-.1 1-.4 1.4A2.8 2.8 0 0 1 21 10.7c0 1-.5 2-1.3 2.5.2.4.3.9.3 1.4a2.9 2.9 0 0 1-2.6 2.9A2.9 2.9 0 0 1 14.5 20c-1.3 0-2.4-.9-2.5-2z"/><path d="M12 5.5V18"/><path d="M8 9.5h2M14 9.5h2M9 13.5h2M13 13.5h2"/></symbol>' +
    '<symbol id="i-whatsapp" viewBox="0 0 24 24"><path d="M3 21l1.7-5A8.5 8.5 0 1 1 8 19.3z"/><path d="M8.6 8.2c.2-.5.4-.5.6-.5h.5c.2 0 .4 0 .6.5l.7 1.7c.1.2.1.4 0 .6l-.4.5c-.1.2-.2.3 0 .6a6 6 0 0 0 2.8 2.4c.3.1.4 0 .6-.1l.5-.6c.2-.2.3-.2.5-.1l1.6.8c.2.1.4.2.4.4v.5c0 .5-.4 1.1-.7 1.3-.4.3-1 .5-1.6.4a9 9 0 0 1-5.6-3.6c-.7-1-1.1-2-1.1-2.9 0-.6.2-1.2.6-1.4z"/></symbol>' +
    ...
    '<symbol id="i-sun" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4.2"/><line x1="12" y1="1.6" x2="12" y2="4"/><line x1="12" y1="20" x2="12" y2="22.4"/><line x1="4.2" y1="4.2" x2="5.9" y2="5.9"/><line x1="18.1" y1="18.1" x2="19.8" y2="19.8"/><line x1="1.6" y1="12" x2="4" y2="12"/><line x1="20" y1="12" x2="22.4" y2="12"/><line x1="4.2" y1="19.8" x2="5.9" y2="18.1"/><line x1="18.1" y1="5.9" x2="19.8" y2="4.2"/></symbol>' +
  ...
  window.Club = window.Club || {};
  window.Club.icon = function (name) {
